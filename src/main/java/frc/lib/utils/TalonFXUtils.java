...
public final class TalonFXUtils {
  ...
  */
  ...
  public static void setPIDF(TalonFX motor, int slot, double kP, double kI, double kD, double kF) {
    motor.config_kP(slot, kP);
    motor.config_kI(slot, kI);
    motor.config_kD(slot, kD);
    motor.config_kF(slot, kF);
  }

  public static void setDefaultPIDF(TalonFX motor, double kP, double kI, double kD, double kF) {
    setPIDF(motor, 0, kP, kI, kD, kF);
  }
}
