...
public class FaceTargetDrive extends TargetAngleDrive {
    ...
    public FaceTargetDrive(DriveCommandConfig drive, PIDController controller, Supplier<Translation2d> targetSupplier) {
        super(drive, controller);
        m_targetSupplier = targetSupplier;
    }

    public FaceTargetDrive(DriveCommandConfig drive, PIDController controller, Translation2d target) {
        this(drive, controller, () -> target);
    }

    public FaceTargetDrive(DriveCommandConfig drive, PIDController controller, Pose2d target) {
